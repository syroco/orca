...
namespace kinematics {
    ...
    , m_numberOfOptimizationVariables(0)
    ...
    void InverseKinematicsData::computeProblemSizeAndResizeBuffers()
    {
        ...
        m_numberOfOptimizationVariables = 3 + sizeOfRotationParametrization(m_rotationParametrization) + m_dofs;
        ...
        m_lowerBoundMultipliers.resize(m_numberOfOptimizationVariables);
        m_lowerBoundMultipliers.zero();
        m_upperBoundMultipliers.resize(m_numberOfOptimizationVariables);
